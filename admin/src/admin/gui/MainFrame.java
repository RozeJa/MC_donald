...
import admin.gui.dataPanesl.ADataPanel;
import admin.gui.forms.EditForm;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame(IDB db, String title)  {
        setTitle(title);
    ...
    private void initFunctions() {
        MouseListener selectDataTyps = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                actualClass = nameToClassMap.get(datatypes.getModel().getElementAt(datatypes.getSelectedIndex()).toString());
                fillDataContent();
            }
        };
    ...
    private EditForm<IData> getForm(IData data) {
        ...
        try {
            form = (EditForm<IData>) Class.forName("admin.gui.forms." + actualClass.getSimpleName() + "Form").getConstructor().newInstance();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public void fillDataContent() {
        ...
        Map<Integer, ? extends IData> data = new TreeMap<>();
        try {
    ...
    private ADataPanel<IData> getNewDataPanel(IData dat) {
        ...
        try {
            panel = (ADataPanel<IData>) Class.forName("admin.gui.dataPanesl." + dat.getClass().getSimpleName() + "Panel").getConstructor().newInstance();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
